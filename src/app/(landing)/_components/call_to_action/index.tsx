import GradientText from "@/components/global/gradient_text"
...
const CallToAction = (props: Props) => {
    return (
        <div className="flex flex-col items-start md:items-center gap-y-5 md:gap-y-0">
            <GradientText
                classname="text-[35px] md:text-[40px] lg:text-[45px] xl:text-[70px] 2xl:text-[80px] leading-tight font-semibold"
                element="H1"
            >
                Bringing Communities Together
            </GradientText>
            <p className="text-sm md:text-center text-left text-muted-foreground">
                FlowLearn is a vibrant online community platform that empowers
